import { getProductsInCartTotalPrice } from './getProductsInCartTotalPrice';
...
const mockedProducts = [
  ...
  it('sholud display total price', () => {
    expect(getProductsInCartTotalPrice(mockedProducts)).toBe(390);
  })